...
#=======================================================================
# Rattle timestamp: 2019-05-08 12:17:04 x86_64-w64-mingw32 

# Load a dataset from file.

fname         <- "file:///C:/Users/hp/Desktop/svyasa/R/Datasets/Thermocouple.csv" 
crs$dataset <- read.csv(fname,
			na.strings=c(".", "NA", "", "?"),
			strip.white=TRUE, encoding="UTF-8")
...
#=======================================================================
# Rattle timestamp: 2019-05-08 12:17:49 x86_64-w64-mingw32 
...
#=======================================================================
# Rattle timestamp: 2019-05-08 12:17:53 x86_64-w64-mingw32 
...
#=======================================================================
# Rattle timestamp: 2019-05-08 12:18:00 x86_64-w64-mingw32 
...
p01 <- crs %>%
  ...
  ggplot2::geom_density(lty=3) +
  ggplot2::xlab("X.U.FEFF.Temp....C.\n\nRattle 2019-May-08 12:18:00 Akash") +
...
#=======================================================================
# Rattle timestamp: 2019-05-08 12:18:05 x86_64-w64-mingw32 
...
#=======================================================================
# Rattle timestamp: 2019-05-08 12:18:12 x86_64-w64-mingw32 
...
#=======================================================================
# Rattle timestamp: 2019-05-08 12:20:54 x86_64-w64-mingw32 

# Load a dataset from file.

fname         <- "file:///C:/Users/hp/Desktop/svyasa/R/Datasets/Yoga - Baseball data for correlation and regression.csv" 
crs$dataset <- read.csv(fname,
			na.strings=c(".", "NA", "", "?"),
			strip.white=TRUE, encoding="UTF-8")
...
#=======================================================================
# Rattle timestamp: 2019-05-08 12:22:52 x86_64-w64-mingw32 
...
crs$target    <- NULL
crs$risk      <- "Runs_Scored"
crs$ident     <- NULL
crs$ignore    <- NULL
crs$weights   <- NULL

#=======================================================================
# Rattle timestamp: 2019-05-08 12:22:59 x86_64-w64-mingw32 
...
#=======================================================================
# Rattle timestamp: 2019-05-08 12:23:05 x86_64-w64-mingw32 
...
#=======================================================================
# Rattle timestamp: 2019-05-08 12:23:41 x86_64-w64-mingw32 
...
#=======================================================================
# Rattle timestamp: 2019-05-08 12:23:49 x86_64-w64-mingw32 
...
#=======================================================================
# Rattle timestamp: 2019-05-08 12:23:57 x86_64-w64-mingw32 
...
#=======================================================================
# Rattle timestamp: 2019-05-08 12:24:06 x86_64-w64-mingw32 
